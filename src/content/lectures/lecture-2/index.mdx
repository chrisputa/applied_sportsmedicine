...
1. [Rationale and Clinical Need](#1-rationale-and-clinical-need)
2. [Conceptual Framework: Two Pathways of Immunological Stress](#2-conceptual-framework-two-pathways-of-immunological-stress)
3. [Standardised Symptom Instruments](#3-standardised-symptom-instruments)
   - 3.1 [Upper Respiratory Tract Infection Screening](#31-upper-respiratory-tract-infection-screening)
   - 3.2 [Training Load and Recovery Monitoring](#32-training-load-and-recovery-monitoring)
   - 3.3 [Symptom Differentiation: Exercise-Induced vs. Infection-Based](#33-symptom-differentiation-exercise-induced-vs-infection-based)
4. [Clinical Signs Relevant to Immunological Stress Evaluation](#4-clinical-signs-relevant-to-immunological-stress-evaluation)
5. [Laboratory Diagnostics: A Tiered Approach](#5-laboratory-diagnostics-a-tiered-approach)
6. [Standardised Decision Algorithms](#6-standardised-decision-algorithms)
   - 6.1 [Algorithm A: Acute Symptom Onset in Athletes](#61-algorithm-a-acute-symptom-onset-in-athletes)
   - 6.2 [Algorithm B: Return-to-Sport Clearance After Confirmed Infection](#62-algorithm-b-return-to-sport-clearance-after-confirmed-infection)
7. [Integration: Immunological Biomarkers in the Context of Trace Elements](#7-integration-immunological-biomarkers-in-the-context-of-trace-elements)
8. [Practical Summary: Standardised Evaluation Checklist](#8-practical-summary-standardised-evaluation-checklist)
...
Mechanistic comparison of exercise-induced and infection-based immunological stress across key dimensions.
</Fragment>
</Table>
...
<Fragment slot="caption">
Differentiating exercise-induced from infection-based symptoms and signs.
</Fragment>
</Table>
...
<Fragment slot="caption">
Standardised evaluation checklist with assessment tools and corresponding action thresholds.
</Fragment>
</Table>
...
1. State two key dimensions on which exercise-induced and infection-based immunological stress differ mechanistically, using the table from the lecture as a reference.
2. What is the WURSS-21 and what does it measure? How is its abbreviated version (WURSS-11) used in sport medicine practice?
3. Explain the clinical principle behind the "neck check" rule and describe a scenario where it would change a training recommendation.
4. Name three validated symptom instruments introduced in this lecture and state the primary domain each assesses.
5. What are the cardinal signs of overtraining syndrome from an immunological perspective, and how do they overlap with infection symptoms?
6. Describe the typical temporal profile of exercise-induced immune stress (onset, duration, resolution) and contrast it with the profile of infection-based stress.
7. Why is a standardised, multi-dimensional assessment framework necessary rather than relying on a single biomarker?
8. Explain how the hallmark laboratory changes differ between exercise-induced lymphocytosis and acute viral infection: which parameters change in each case?
9. What is the role of CRP as a marker in the standardised evaluation framework, and what are its limitations in the exercise context?
10. Describe one clinical decision algorithm introduced in today's lecture and explain the key branch points.
11. How does the concept of "load–capacity mismatch" help integrate immunological and sports-science perspectives in clinical evaluation?
12. Name two patient-reported outcome measures recommended for tracking immunological recovery in athletes and state their measurement domains.
13. Under what circumstances should a sports medicine practitioner refer an athlete for Level 2 or Level 3 immunological laboratory diagnostics?
14. What distinguishes a symptom from a sign in clinical assessment, and why does this distinction matter in the evaluation framework?
15. Explain how the subjective athlete report and objective laboratory data should be weighted when they are contradictory.
16. What is the significance of tracking "functional impact on sport performance" as a dimension in symptom surveys, beyond pure severity scoring?
17. Describe one potential error in clinical reasoning that the standardised framework is specifically designed to prevent.
18. How would you explain the key message of this lecture to a coach in two sentences, without using technical jargon?
19. Which concept from today's framework did you find most novel or counterintuitive, and why?
20. What single unresolved clinical question about the evaluation of immunological stress in athletes would you most like answered?
