...
1. [Overview](#overview)
2. [Hop Tests and Functional Symmetry](#1-hop-tests-and-functional-symmetry)
3. [Y-Balance Test (YBT) – Dynamic Balance](#2-y-balance-test-ybt--dynamic-balance)
4. [Star Excursion Balance Test (SEBT)](#3-star-excursion-balance-test-sebt)
5. [CAIT – Cumberland Ankle Instability Tool](#4-cait--cumberland-ankle-instability-tool)
6. [I-PRRS – Psychological Readiness to Return to Sport](#5-i-prrs--psychological-readiness-to-return-to-sport)
7. [MIS – Manchester Instability Score](#6-mis--manchester-instability-score)
8. [Normalized Balance Reach Distances](#7-normalized-balance-reach-distances)
9. [Clinical Traffic Light Classification](#8-clinical-traffic-light-classification)
10. [Evidence-Based Interpretation](#9-evidence-based-interpretation)
    - [Test 1 – Early Rehabilitation Phase (76 days post-injury)](#test-1--early-rehabilitation-phase-76-days-post-injury)
    - [Test 2 – Late Rehabilitation Phase (166 days post-injury)](#test-2--late-rehabilitation-phase-166-days-post-injury)
...
Timing of the two RTC test battery assessments for athlete xyz18 (KS224).
</Fragment>
</Table>
...
<Fragment slot="caption">
Traffic light classification across the 16 test domains at both assessments.
</Fragment>
</Table>
...
<Fragment slot="caption">
Summary of RTC battery domains across both test points with clinical assessment.
</Fragment>
</Table>
